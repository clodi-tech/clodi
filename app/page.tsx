    ...
    return (
        <main>
            <div className='flex flex-col gap-4 max-w-sm'>
                ...
                <p className='text-justify'>Today, my journey is about finding that <b>Enough</b> - a point in time and space where abundance meets us and <u>we have everything we need</u>. I feel it is somewhere within ourselves and a mindful use of technology may guide us there.</p>
                <p className='text-justify'>I am here to craft <b>systems</b> you can use, write <b>notes</b> you can read. And if you start questioning what is Enough for you, subscribe for free and start your journey with five quests about Enough.</p>
